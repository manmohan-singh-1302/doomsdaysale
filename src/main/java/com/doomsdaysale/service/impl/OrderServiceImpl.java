...
import com.doomsdaysale.repository.OrderItemRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    /*
    * createOrder method converts the user's cart into one or more orders grouping them by seller id.
    * */
    @Override
    public Set<Order> createOrder(User user, Address shippingAddress, Cart cart) {
        ...
        // maps the cart items by seller id.
